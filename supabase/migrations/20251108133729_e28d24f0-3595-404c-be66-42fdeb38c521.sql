-- Update the complete_matured_investments function to transfer profit to wallet balance
...
AS $function$
BEGIN
  -- Update investments that have matured and transfer profit to wallet
