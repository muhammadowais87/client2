-- Update approve_deposit to NOT add amount to wallet_balance (money goes directly to investment)
...
BEGIN
  ...
  -- Only update total_deposits and total_investment (not wallet_balance)
  ...
  -- Create investment (money is locked for 5 days)
  ...
  -- Process referral commissions (add to wallet balance directly)
...
-- Update add_manual_deposit to NOT add amount to wallet_balance (money goes directly to investment)
